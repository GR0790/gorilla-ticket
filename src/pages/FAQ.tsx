      ...
      questions: [
        {
          ...
          answer:
            "소액결제현금화는 개인에게 부여된 휴대폰 소액결제 한도를 사용하여, 모바일 상품권 등 디지털 상품을 구매한 뒤 이를 판매하여 현금으로 전환하는 서비스입니다. SKT, KT, LG U+ 등 모든 통신사 고객님이 이용 가능하며, 저희 고릴라티켓은 합리적인 지급률로 신속하고 안전한 서비스를 제공합니다.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "지급률은 결제하신 금액 대비 실제로 입금받으시는 현금의 비율을 의미합니다. 예를 들어 지급률이 80%라면, 10만원을 결제했을 때 8만원을 입금받게 됩니다. 고릴라티켓은 불필요한 운영비를 줄여 합리적인 지급률로 고객님께 좋은 혜택을 드리기 위해 노력합니다.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "네, SKT(SK텔레콤), KT, LG U+ 3대 통신사 모두 이용 가능합니다. 통신사 종류에 관계없이 동일하게 빠른 처리를 위해 노력합니다. 본인 명의 휴대폰이라면 통신사 구분 없이 고릴라티켓 소액결제현금화를 이용하실 수 있습니다.",
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            "네, 가능합니다. 고릴라티켓은 미납·정책으로 인해 결제가 어려운 고객님들을 위한 특별 노하우를 보유하고 있으며, 미납·정책 관련 다수의 상담 사례를 보유하고 있습니다. 다른 업체에서 거절당했더라도 포기하지 마시고 먼저 상담받아보세요.",
        },
        {
      ...
      questions: [
        {
          ...
          answer:
            "네, 고릴라티켓은 정식 사업자등록을 마친 합법적인 업체입니다. 월 3만건 이상의 풍부한 거래실적과 높은 고객만족도가 안전성을 증명합니다. 또한 모든 상담 및 거래 정보는 SSL 보안 시스템으로 암호화되어 안전하게 보호됩니다.",
        },
        {
